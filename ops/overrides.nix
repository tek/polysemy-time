...
lower-polysemy-time = {
  Cabal = {
  meta = {
    sha256 = "1zz55xinqhg40zyfdvfzbianbdr7542ypq9ib5sj215ach6afpr8";
    ver = "3.10.3.0";
  };
...
mkDerivation {
  pname = "Cabal";
  version = "3.10.3.0";
  src = /nix/store/303015cm40nx3qqryvg2ibzlf6gvya7s-source;
...
;
  Cabal-syntax = {
  meta = {
    sha256 = "1lsharrf1nv7zk17r6cm9z3jglyany3hpyqqf6r5a9myp1mn6v1n";
    ver = "3.10.3.0";
  };
...
mkDerivation {
  pname = "Cabal-syntax";
  version = "3.10.3.0";
  src = /nix/store/3igc41h12ns67ppqydj46c7qifng2h5i-source;
  libraryHaskellDepends = [
...
;
  polysemy-test = {
  meta = {
    sha256 = "0j33f5zh6gyhl86w8kqh6nm02915b4n32xikxc4hwcy7p5l7cl34";
    ver = "0.3.1.7";
  };
  drv = { mkDerivation, base, containers, either, hedgehog, lib, path
...
mkDerivation {
  pname = "polysemy-test";
  version = "0.3.1.7";
  src = /nix/store/b6cc07s27qih42macv1wa05i8p0yfrfi-source;
  enableSeparateDataOutput = true;
  libraryHaskellDepends = [
...
;
  process = {
  meta = {
    sha256 = "1cy2yn7ag10zrrv4l2vcswmljcgl1hv493v13fsvpc8y8m1qb4qa";
    ver = "1.6.20.0";
  };
...
mkDerivation {
  pname = "process";
  version = "1.6.20.0";
  src = /nix/store/5c7bii1s0i8qmrffszwz4qns4k92b44m-source;
...
;
  unix-compat = {
  meta = {
    sha256 = "0zs2x3mrfn0piavs8pf0zs6c4cadij2bkwd9gkd7qhb7jnqqhhp7";
    ver = "0.7.1";
  };
  drv = { mkDerivation, base, directory, extra, hspec, HUnit, lib
, monad-parallel, temporary, unix
}:
mkDerivation {
  pname = "unix-compat";
  version = "0.7.1";
  src = /nix/store/rcglz3cfzycq3cydhy9cb4ik7qpvvj55-source;
